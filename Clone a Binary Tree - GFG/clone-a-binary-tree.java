...
class Solution{
    public Tree cloneTree(Tree tree){
     ...
     public static void createDuplicates(Tree tree){
        if(tree == null)  return;
     ...
     public static void setRandom(Tree orig){
         if(orig == null) return;
     ...
     public static Tree removeDuplicates(Tree node){
         if(node == null) return null;
         
         Tree ln = removeDuplicates(node.left.left);
         Tree rn = removeDuplicates(node.right);
